...
### [ConnectivityComponents](./CPPSolves/ConnectivityComponents.cpp)

Дан неориентированный невзвешенный граф. Необходимо посчитать количество его компонент связности и вывести их

### [CheckTree](./CPPSolves/CheckTree.cpp)
...
### [Cycle](./CPPSolves/Cycle.cpp)

Дан ориентированный невзвешенный граф. Необходимо определить есть ли в нём циклы, и если есть, то вывести любой из них

### [City](./CPPSolves/City.cpp)
...
### [Flounder](./CPPSolves/Flounder.cpp)
...
### [Red-Blue graph](./CPPSolves/RedGraph.cpp)
...
### [Bellman-Ford](./CPPSolves/Bellman-Ford.cpp)
...
### [Shortest Path](./CPPSolves/ShortestPath.cpp)
...
### [Convex Hull](./CPPSolves/ConvexHull.cpp)
...
### [Alternation](./CPPSolves/Alternation.cpp)
...
### [Treap with explicit key](./CPPSolves/TreapExplicit.cpp) 

Реализуйте сбалансированное двоичное дерево поиска

### [Treap with implicit key](.CPPSolves/TreapImplicit.cpp) 
...
### [Treap + segment tree sum](./CPPSolves/TreapSum.cpp) 
